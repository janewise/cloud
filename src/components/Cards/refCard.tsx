...
const RefUpgradeButton: FunctionComponent<ButtonProps> = (
  props: ButtonProps
) => {
  ...
  useEffect(() => {
    ...
    const userRef = ref(db, `users/${props.userId}/inviteCount`);
      ...
      >
        ...
        >
          <Button
            ...
            id={props.id}
            disabled={
              inviteCount < props.refshow || props.balance < props.cost
                ? true
                : false
            }
          ...
          >
            ...
            <p className="pricetext">
              {inviteCount < props.refshow
                ? `invite ${props.refshow} friends`
                : `Level: ${props.level} | Cost: ${addcomma(
...
export default RefUpgradeButton;
